<?php
	...
	Class ContentExtensionSitemap_XmlRaw extends AdministrationPage{
		...
		function view(){
			...
			$tmp = array(URL, 'http://www.唐齊.tw', 'http://www.唐齊.台灣');	
			// iterate over each page
			foreach($this->_pages as $page) {
				// Display the different domain	
				...
				} // modified by Kevin Chen @chusang 2013-12-23	
			}
